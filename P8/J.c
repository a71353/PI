...
void unit_test_ints_find_triple(void)
{
  ...
  assert(ints_find_triple(a1, 12) == 4);
  assert(ints_find_triple(a1, 3) == -1);
  int a2[8] = {1, 2, 3, 4, 4, 4, 5, 8};
  assert(ints_find_triple(a2, 8) == 3);
  assert(ints_find_triple(a2, 2) == -1);
}
